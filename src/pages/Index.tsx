  ...
  return (
    ...
    >
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div className="gsap-reveal">
              <div className="relative w-full aspect-square max-w-md mx-auto overflow-hidden rounded-2xl">
                ...
                <div className="absolute bottom-4 right-4 bg-accent rounded-full p-2">
                  <img
                    src="https://images.velog.io/images/jjelly/post/14100e19-4df2-4fbf-9629-0944b587bf7a/javascript-frameworks.jpg"
                    alt="Finlon logo"
            ...
            <div className="glass p-8 gsap-reveal">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                I'm a passionate web developer with skills in JavaScript, React,
                Redux, Tailwind CSS, SQL, AWS, Azure, and Figma. I love building
                innovative web solutions that combine technical excellence with
                great design.
              </p>
      ...
      <section
        id="skills"
        ref={skillsRef}
        className={`py-20 px-4 ${isDarkMode ? "bg-black/30" : "bg-black/5"}`}
      >
        <div className="container max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center gradient-text gsap-reveal">
            Skills
        ...
        <div className="container max-w-6xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto glass p-8 gsap-reveal">
            ...
            <p className="text-gray-300 leading-relaxed">
              Working with cutting-edge cybersecurity technologies to develop
              and enhance protection systems for enterprise customers. Focused
              on web application security and threat detection.
            </p>
          </div>
        </div>
      </section>
